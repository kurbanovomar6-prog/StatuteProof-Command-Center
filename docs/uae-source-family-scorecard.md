...
| SCA | 6 | 6 | 0 | 15 | 4 | Partial | 3.0 | 6 | Below target after adding SCA FinTech Regulatory Sandbox. SCA table/download adapter fixture now passes; live regulations-listing remains NAV_SHELL_ONLY and needs public rendered-table/API investigation before evidence or activation. Do not bypass robots, WAF, or access controls. |
