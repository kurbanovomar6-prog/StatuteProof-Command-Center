...
def main() -> None:
    ...
    if not args:
        ...
        print("  python run.py discover-source <url>                      analyse a URL with the Source Connection Engine", file=sys.stderr)
        print("  python run.py discover-source <url> --json               same + export reports/discover_source_*.json", file=sys.stderr)
