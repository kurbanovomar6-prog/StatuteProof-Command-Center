...
export const FAMILY_QUALITY = [
  ...
  },
  {
    ...
    status: "partial",
    gapTo25: 19,
    notes: "SCA has 6 proof-backed fresh-alert direct/listing sources after the official regulations listing passed proof-backed repeat baseline and mass-monitor MONITOR_OK. SCA AML/CFT parser/noise review still blocks broad SCA positioning.",
  },
  {
    family: "UAE FIU",
    totalEnabled: 8,
...
export const KNOWN_LIMITATIONS = [
  ...
  {
    source: "SCA",
    limitation: "SCA has 6 proof-backed fresh-alert direct/listing sources. SCA AML/CFT parser/noise review remains unresolved and SCA root portal monitoring remains unclaimed.",
    impact: "partial_coverage",
