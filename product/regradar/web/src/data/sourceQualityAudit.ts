...
export const FAMILY_QUALITY = [
  ...
  },
  {
    ...
    status: "remediation",
    gapTo25: 25,
    notes: "All 7 MoE DNFBP sources remain under source remediation — earlier captures were a site-maintenance page, which the quality gate rejects; none is counted until re-baselined on real content. One evidence-library homepage is kept as a snapshot only.",
  },
  {
    family: "FTA",
    totalEnabled: 6,
