...
// Source count: 72 enabled UAE sources, 68 readiness-supported after proof/baseline gates (as of 2026-06)
...
export const PLAN_CAPABILITIES = {
  ...
  professional: {
    liveMonitoring: true,
    sourceLimit: 68,           // 68 readiness-supported UAE sources after proof/baseline gates
