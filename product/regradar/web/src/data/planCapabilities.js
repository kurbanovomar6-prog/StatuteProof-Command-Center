...
// Source count: 79 enabled UAE sources, 76 readiness-supported after proof/baseline gates (as of 2026-06)
...
export const PLAN_CAPABILITIES = {
  ...
  professional: {
    liveMonitoring: true,
    sourceLimit: 76,           // 76 readiness-supported UAE sources after proof/baseline gates
