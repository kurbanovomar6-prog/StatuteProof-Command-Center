...
// Source count: 19 enabled UAE sources under evidence-readiness validation (as of 2026-06)
...
export const PLAN_CAPABILITIES = {
  ...
  professional: {
    liveMonitoring: true,
    sourceLimit: 19,           // 19 enabled UAE sources under evidence-readiness validation
