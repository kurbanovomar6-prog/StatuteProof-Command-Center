export const sourceHealthRows = [
  { id: 1,  name: 'CBUAE Main',                  jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 2,  name: 'CBUAE Regulations',           jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 3,  name: 'UAE Ministry of Finance',     jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 4,  name: 'VARA Main',                   jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 5,  name: 'VARA Enforcement Notices',    jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 6,  name: 'ADGM FSRA Main',              jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 7,  name: 'UAE FIU Circulars',           jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 8,  name: 'DIFC Laws Portal',            jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 9,  name: 'UAE Legislation Portal',      jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
  { id: 10, name: 'UAE Ministry of Economy',     jurisdiction: 'AE', flag: '🇦🇪', access: 'Accessible', quality: 'confirmed',   status: 'confirmed',   verdict: 'CONFIRMED' },
...
export const features = [
  ...
  { icon: 'BarChart2',     title: 'Source readiness reporting',       desc: 'Source checks show confirmed, limited, and blocked sources before a pilot begins, with access restrictions documented.' },
...
export const coverage = [
  {
    ...
    region: 'UAE',
    sources: [
      { name: 'CBUAE Main', status: 'confirmed' },
      { name: 'CBUAE Regulations', status: 'confirmed' },
      { name: 'UAE Ministry of Finance', status: 'confirmed' },
      { name: 'VARA Main', status: 'confirmed' },
      { name: 'VARA Enforcement Notices', status: 'confirmed' },
      { name: 'ADGM FSRA Main', status: 'confirmed' },
      { name: 'UAE FIU Circulars', status: 'confirmed' },
      { name: 'DIFC Laws Portal', status: 'confirmed' },
      { name: 'UAE Legislation Portal', status: 'confirmed' },
      { name: 'UAE Ministry of Economy', status: 'confirmed' },
...
export const pricingPlans = [
  ...
  },
  {
    ...
    desc: 'MLRO or CCO workspace for the UAE pack. 13 enabled sources under evidence-readiness review: 10 confirmed, 3 under extraction remediation.',
    features: [
      '13 enabled UAE sources under review',
...
export const steps = [
  { n: '01', title: 'Source readiness assessment', desc: 'Each official source is tested before monitoring begins: is it accessible? What extraction method does it require? What is the quality of extracted content? Confirmed, Limited, and Blocked sources are documented. You see this before agreeing to a pilot.' },
