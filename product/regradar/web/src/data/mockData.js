export const sourceHealthRows = [
  ...
  { id: 7,  name: 'UAE FIU Publications Hub',    jurisdiction: 'AE', flag: '🇦🇪', access: 'Geo-restricted', quality: 'geo_blocked', status: 'geo_blocked', verdict: 'BLOCKED' },
...
export const features = [
  { icon: 'Search',        title: 'Official-source monitoring',      desc: 'Your selected UAE regulatory sources are configured to be checked on a defined schedule once monitoring is activated — VARA, DFSA, ADGM/FSRA, and more. When something changes on an official portal, the change is captured from the source, not from a peer.' },
...
export const coverage = [
  {
    ...
    sources: [
      ...
      { name: 'UAE FIU Publications Hub', status: 'geo_blocked' },
...
export const pricingPlans = [
  ...
  },
  {
    ...
    desc: 'Selected official UAE regulatory source pack across VARA, DFSA, ADGM, DIFC and related public authorities. Built for an MLRO who needs evidence that regulatory changes were tracked.',
    features: [
