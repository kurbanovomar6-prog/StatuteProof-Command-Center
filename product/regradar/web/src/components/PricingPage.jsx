...
const PLANS_DATA = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Audit binder export', value: 'Markdown/HTML included; PDF not enabled' },
      { label: 'PDF / Markdown export', value: 'Markdown/HTML included; PDF not enabled' },
      { label: 'Users', value: '2' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: 'Audit binder export', value: 'Markdown/HTML included; PDF roadmap' },
