...
const PLANS_DATA = [
  {
    id: 'free',
    name: 'Free Source Readiness Review',
    price: 'Free',
    ...
    features: [
      ...
      { label: 'Source readiness review (sample)', value: true },
  ...
  },
  {
    ...
    badge: null,
    highlight: false,
    purpose: 'Small team first monitoring pilot.',
    ...
    features: [
      ...
      { label: 'Basic diff view', value: true },
      { label: 'Custom sources', value: false },
      { label: 'Weekly MLRO brief', value: 'Limited' },
      { label: 'Audit binder export', value: false },
      { label: 'Users', value: '1' },
  ...
  },
  {
    ...
    badge: 'Most popular',
    highlight: true,
    purpose: 'Main plan for UAE MLRO / compliance team.',
    cta: 'Upgrade to Professional',
    ctaPrimary: true,
    features: [
      { label: 'Official UAE sources', value: '13–16 sources' },
      { label: 'Source readiness review', value: true },
      { label: 'Evidence records + full diff view', value: true },
      { label: '3 custom public sources', value: true },
      { label: 'Weekly MLRO brief', value: true },
      { label: 'High-risk review queue', value: true },
      { label: 'Audit binder export', value: true },
      { label: 'PDF / Markdown export', value: true },
      { label: 'Users', value: '3' },
  ...
  },
  {
    ...
    badge: null,
    highlight: false,
    purpose: 'Consultants managing multiple client workspaces.',
    cta: 'Talk to us',
    ctaPrimary: false,
    features: [
      { label: 'Official UAE sources', value: '25+' },
      { label: 'Source readiness review', value: true },
      { label: 'Evidence records + full diff view', value: true },
      { label: 'Custom sources', value: '10+' },
      { label: 'Weekly MLRO brief', value: true },
      { label: 'High-risk review queue', value: true },
      { label: 'Audit binder export', value: true },
      { label: 'White-label reports', value: true },
      { label: 'Users', value: 'Custom' },
      { label: 'Evidence retention', value: 'Custom' },
      { label: 'Multiple workspaces', value: true },
    ],
  },
]
