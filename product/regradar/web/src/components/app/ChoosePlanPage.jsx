...
const PLANS = [
  ...
  },
  {
    ...
    badge: 'Recommended',
    highlight: true,
    desc: '226 enabled UAE official-source endpoints, including 225 monitoring-active after proof and baseline gates. Full evidence workflow with high-risk review queue.',
    cta: 'Upgrade to UAE Monitor',
    ctaStyle: 'primary',
    features: [
      '225 monitoring-active UAE sources',
