...
function buildSummaryText(company, markets, topics, delivery) {
  ...
  return [
    ...
    '',
    'Note: Actual pilot setup depends on validated official sources and access limitations per market.',
  ].join('\n')
}
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400 leading-relaxed">
                  This preview is illustrative. Actual pilot setup depends on validated official sources and access limitations per market.
          ...
          <div className="space-y-8">
            ...
            <div className="bg-[#0D1B2E] border border-slate-800 rounded-xl p-5">
              ...
              <p className="text-[11px] text-slate-600 mt-3">
                Market availability depends on validated official sources and access limitations.
              </p>
            </div>
          ...
          <div className="lg:sticky lg:top-8 space-y-4">
            ...
            <div className="bg-slate-800/40 border border-slate-700/40 rounded-xl px-4 py-3">
              <p className="text-[11px] text-slate-500 leading-relaxed">
                StatuteProof does not claim complete legal coverage. Each pilot uses a validated set of
