...
const REPORTS = [
  {
    ...
    keyUpdate: 'Mapped source layers are grouped by readiness status. Only fresh-alert eligible sources can move toward monitoring profiles after proof/diff checks and limitations review.',
    ...
    steps: [
      ...
      'Confirm which sources are fresh-alert eligible, under validation, under technical review or limited',
  ...
  },
  {
    ...
    summary: 'Source transparency sample for DIFC fresh-alert eligible legal sources.',
    date: 'Sample',
    sourceUrl: 'dfsa.ae / difc.com',
    executive: 'Sample report showing selected DIFC legal and data-protection sources as fresh-alert eligible. Static detail pages remain evidence-library only.',
    keyUpdate: 'The report separates mapped sources from fresh-alert eligible, under review, and limited sources, with limitations documented near each source layer.',
    whyMatters: 'DIFC-regulated firms need clear source provenance before using any alert workflow.',
    steps: [
      'Review DFSA rulebook scope boundary',
    ...
    evidence: { sourceHealth: 'Readiness-supported + remediation', changeType: 'Source transparency sample', aiConfidence: 'Medium', note: 'DFSA rulebook covered via Thomson Reuters modules.' },
  },
  {
    ...
    keyUpdate: 'Selected ADGM/FSRA sources are fresh-alert eligible with caveats; FSRA circular/rulebook layers remain outside fresh-alert scope until checks clear.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Activate only fresh-alert eligible sources after proof/diff checks',
    ],
