...
const REPORTS = [
  {
    ...
    keyUpdate: 'Mapped source layers are grouped by monitoring status. Only monitoring-active sources can move toward monitoring profiles after proof/diff checks and limitations review.',
    ...
    steps: [
      ...
      'Confirm which sources are monitoring-active, under validation, under technical review or limited',
  ...
  },
  {
    ...
    summary: 'Source transparency sample for DIFC monitoring-active legal sources.',
    date: 'Sample',
    sourceUrl: 'dfsa.ae / difc.com',
    executive: 'Sample report showing DIFC legal and data-protection sources as monitoring-active. DFSA rulebook is covered via Thomson Reuters modules.',
    keyUpdate: 'The report separates mapped sources from monitoring-active, under review, and limited sources, with limitations documented near each source layer.',
  ...
  },
  {
    ...
    keyUpdate: 'The ADGM/FSRA main source is monitoring-active with caveats; FSRA circular/rulebook layers remain outside monitoring-active scope until checks clear.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Activate only monitoring-active sources after proof/diff checks',
    ],
