...
const REPORTS = [
  {
    ...
    keyUpdate: 'Mapped source layers are grouped by readiness state. Only readiness-supported sources can move toward monitoring profiles after proof/diff checks and limitations review.',
    ...
    steps: [
      ...
      'Confirm which sources are readiness-supported, under validation, under extraction remediation or limited',
  ...
  },
  {
    ...
    summary: 'Source transparency sample for DIFC readiness-supported legal sources and DFSA remediation layers.',
    date: 'Sample',
    sourceUrl: 'dfsa.ae / difc.com',
    executive: 'Sample report showing DIFC legal and data-protection sources as readiness-supported while DFSA rulebook and notices remain remediation for a pilot profile.',
    keyUpdate: 'The report separates mapped sources from readiness-supported, remediation and limited sources, with limitations documented near each source layer.',
    ...
    steps: [
      ...
      'Confirm which DIFC legal/data-protection sources are in scope',
      'Flag WAF or mirror limitations if present',
      'Confirm pilot scope before activation',
    ],
    evidence: { sourceHealth: 'Readiness-supported + remediation', changeType: 'Source transparency sample', aiConfidence: 'Medium', note: 'DFSA rows require remediation before activation.' },
  },
  {
    ...
    keyUpdate: 'The ADGM/FSRA main source is readiness-supported with caveats; FSRA circular/rulebook layers remain outside readiness-supported scope until checks clear.',
  ...
  },
  {
    ...
    keyUpdate: 'Readiness-supported, under-validation, limited and blocked statuses are disclosed separately so mapped sources are not confused with live monitoring.',
    ...
    steps: [
      ...
      'Activate only readiness-supported sources after proof/diff checks',
    ],
