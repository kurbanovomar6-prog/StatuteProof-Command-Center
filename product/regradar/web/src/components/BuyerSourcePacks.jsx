...
const PACKS = [
  {
    ...
    layers: [
      ...
      { text: 'VARA AML/CFT Rulebook and public register', status: 'active' },
    ],
    caveat: null,
  },
  {
  ...
  },
  {
    ...
    layers: [
      ...
      { text: 'ADGM FSRA guidance, policy statements and notices', status: 'active' },
    ],
  ...
  },
  {
    ...
    coverage: 'strong',
    layers: [
      { text: 'UAE FIU publications hub and Laws-Regulations section', status: 'active' },
  ...
  },
  {
    ...
    layers: [
      ...
      { text: 'FTA — VAT public clarifications and listing pages', status: 'pending' },
      { text: 'FTA — Corporate Tax listing-page item extraction', status: 'pending' },
    ],
    caveat: '25 direct official FTA PDF endpoints and the UAE Legislation Portal are fresh-alert eligible. FTA listing and guide index pages are active in the system pending item-level extraction proof.',
  },
  {
