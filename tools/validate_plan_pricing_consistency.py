...
def main() -> int:
    ...
    if PLAN_CAPABILITIES["professional"].get("source_limit") != 169:
        errors.append("Backend professional source_limit must be 169.")
    ...
    print("- UAE Monitor fresh-alert source limit and retention agree")
