...
- Current source truth (79 enabled / 78 readiness-supported / 1 remediation) is intact
...
print("\nCheck 7: sources.json integrity — 79 enabled / 78 readiness-supported / 1 remediation...")
EXPECTED_ENABLED = 79
EXPECTED_READINESS = 78
