...
- Current source truth (79 enabled / 76 readiness-supported / 3 remediation) is intact
...
print("\nCheck 7: sources.json integrity — 79 enabled / 76 readiness-supported / 3 remediation...")
EXPECTED_ENABLED = 79
EXPECTED_READINESS = 76
