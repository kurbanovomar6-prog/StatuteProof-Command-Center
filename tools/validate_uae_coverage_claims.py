...
- Current source truth (81 enabled / 80 monitoring-active / 1 remediation) is intact
...
print("\nCheck 7: sources.json integrity — 81 enabled / 80 monitoring-active / 1 remediation...")
EXPECTED_ENABLED = 81
EXPECTED_READINESS = 80
